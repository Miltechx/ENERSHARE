      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
        <div className="bg-gray-800 rounded-2xl p-8 max-w-md text-center">
          ...
          <p className="text-gray-400 mb-4">
            You are number <span className="text-green-500 font-bold">#{waitlistCount}</span> on the waitlist.
          </p>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Be among the first to trade energy in Nigeria. Early members get 30 days free on Producer plan.
          </p>
